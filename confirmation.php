                        ...
                        <div class="col-lg-12" style="margin-bottom:150px">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   ...
                                   Bienvenue sur <a href="checkout.html">E-medical</a><center> <p class="payment_policy" style="text-align:center,color:green !important">  <br>
                                    <h3>
                                    <strong>
                                   
                                </div>
                                    </strong>
                                     <center> <h4>Payement effectué avec succès ! </h4>
                                         <img id="logo-img" class="img-center" width="50px" src="images/validation.png" alt="logo">   
                                    </center>
